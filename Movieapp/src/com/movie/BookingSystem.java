...
//	
//	public void displayRoomOne(ArrayList<Integer> seats) {
...
//	}
	...
	//books a movie
	public Booking bookMovies(User user, Movie movie, String selectedSeat) {
		Booking newBooking = new Booking(user, movie, selectedSeat);
	...
	public void saveBookingToFIle(String filename, ArrayList<Booking>bookings ) throws IOException {
